...
function usePopover(props) {
  ...
  var shouldRenderChildren = !isLazy || hasBeenOpened.current;
  ...
  var getPopoverPositionerProps = (0, _react.useCallback)(function (props, forwardedRef) {
    ...
    return getPopperProps(_extends({}, props, {
      style: _extends((_extends2 = {}, _extends2[_popper.popperCSSVars.arrowSize["var"]] = arrowSize ? (0, _utils.px)(arrowSize) : undefined, _extends2[_popper.popperCSSVars.arrowShadowColor["var"]] = arrowShadowColor, _extends2.visibility = isOpen ? "visible" : "hidden", _extends2), props.style)
    }), forwardedRef);
